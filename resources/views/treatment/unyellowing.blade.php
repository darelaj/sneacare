        ...
        <div class="justify-center flex-1 max-w-6xl py-4 mx-auto lg:py-6 md:px-2">
            <div class="flex flex-wrap mt-[50px] ">
                ...
                <div class="w-[500px] h-[750px] px-10 mr-32 mb-10 lg:mb-0">
                    <div class="relative">
                        <img src="https://cdn.discordapp.com/attachments/698554518278897664/1192905353080344596/unyellowing.jpg" alt="aboutimage"
                ...
                <div class="w-1/2 px-4 mb-10 mt-10 lg:w-1/2 lg:mb-0 ">
                    ...
                    Repaint sepatu adalah pengecatan ulang untuk memberikan tampilan baru pada sepatu. Langkah-langkahnya 
                    melibatkan persiapan, pemilihan cat, masking, pengecatan, dan penyelesaian. 
                    Ini adalah cara ekonomis untuk memperbarui sepatu yang mengalami kerusakan warna layak nya sepatu baru.
                    </p>

                    <img src="https://cdn.discordapp.com/attachments/698554518278897664/1192893937359278290/Frame_58.png" alt="">
