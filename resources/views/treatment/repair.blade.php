            ...
            <div class="flex flex-wrap mt-[50px] ">
                <div class="w-full px-4 mb-2 mt-10 lg:w-1/2 lg:mb-0">
                    ...
                    <div class="w-[500px] h-[750px] px-10 mr-32 mb-10 lg:mb-0">
                        <div class="relative">
                            <img src="https://cdn.discordapp.com/attachments/698554518278897664/1192866625632882808/pict_1.jpg"
                ...
                <div class="w-1/2 px-4 mb-10 mt-10 lg:w-1/2 lg:mb-0 ">
                    ...
                    <p class="mt-6 mb-10 text-base leading- text-gray-500 dark:text-gray-400">
                        Repair sepatu adalah proses perbaikan kerusakan pada sepatu, seperti sol yang lepas, retak, atau
                        bagian atas yang rusak.
                        Ini melibatkan perekatan sol, penggantian hak, perbaikan bagian atas, dan pemulihan kulit.
                        Pekerjaan ini membantu memperpanjang umur sepatu dan mengurangi limbah.
                    </p>
